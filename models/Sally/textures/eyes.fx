...
#define ShadowDarkness   1.0    // セルフシャドウの最大暗さ
#define UnderSkinDiffuse 1.5    // 皮下散乱
#define EyeLightPower    0.5    // 視線方向での色合いの変化
#define ToonPower        1.0    // 影の暗さ
#define OverBright       1.5    // 白飛び覚悟の明るさ補正
#define FresnelCoef      5.0    // フレネル項の係数
...
#define USE_NORMAL_MAP // 使う? (使わない場合、左に//)
    #define NORMAL_MAP_PATH "chr_classic_sonic_eye_nrm_HD_RG.png"
